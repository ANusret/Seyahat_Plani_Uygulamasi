...
class ikincirotas2 extends StatefulWidget {
  ikincirotas2({Key? key, required this.mekanlarSet}) : super(key: key);
  Set<Marker> mekanlarSet;

  @override
  State<ikincirotas2> createState() => _ikincirotas2State();
}

class _ikincirotas2State extends State<ikincirotas2> {
