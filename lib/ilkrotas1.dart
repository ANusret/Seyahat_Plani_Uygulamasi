...
import 'package:gmap/ikincirotas1.dart';
...
class ilkrotas1 extends StatefulWidget {
  ilkrotas1({Key? key, required this.mekanlarSet}) : super(key: key);
  Set<Marker> mekanlarSet;

  @override
  State<ilkrotas1> createState() => _ilkrotas1State();
}

class _ilkrotas1State extends State<ilkrotas1> {
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      ikincirotas1(mekanlarSet: widget.mekanlarSet)));
        },
